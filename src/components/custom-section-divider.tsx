  ...
  ({ 
    ...
    return (
      <div ref={ref} className={cn("relative w-full h-32", className)} {...props}>
        ...
        <div className="absolute top-1/2 -translate-y-1/2 z-20 left-12 md:left-16 lg:left-20 pointer-events-none bg-background">
        ...
        <div className="absolute top-1/2 z-20 pt-2 left-11 md:left-16 lg:left-20 pointer-events-none">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-[700] font-inter text-gold leading-none">
          {bottomTitle}
          </h2>
        </div>
      </div>
