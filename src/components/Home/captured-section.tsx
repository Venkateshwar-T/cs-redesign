  ...
  export default function CapturedSection({ images }: CapturedSectionProps) {
    return (
      <>
        ...
        <div className="flex flex-col md:flex-row items-center md:h-[20rem] lg:h-[26rem] w-full justify-between px-6 md:px-10 lg:px-12 gap-6 lg:gap-8">
          
          {/* Text */}
          <div className="flex flex-col w-[80%] md:w-[45%] lg:w-[50%] justify-center gap-4 md:gap-8 lg:px-12">
            ...
            <div className="text-[1rem] lg:text-[1.1rem] text-end font-lora font-thin mr-6">
              - Team ChocoSmiley
            </div>
          </div>
  
          {/* Slideshow */}
          <div className="h-[300px] md:h-full w-full md:w-[55%] lg:w-[50%] lg:px-8">
